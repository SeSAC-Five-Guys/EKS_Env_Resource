...
cd ~/environment/
#VPC ID export
export vpc_ID=$(aws ec2 describe-vpcs --filters Name=tag:Name,Values=mj-test-stack | jq -r '.Vpcs[].VpcId')
echo $vpc_ID
...
export PublicSubnet01=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=mj-test-stack-PublicSubnet01' | jq -r '.Subnets[].SubnetId')
export PublicSubnet02=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=mj-test-stack-PublicSubnet02' | jq -r '.Subnets[].SubnetId')
export PublicSubnet03=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=mj-test-stack-PublicSubnet03' | jq -r '.Subnets[].SubnetId')
export PrivateSubnet01=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=mj-test-stack-PrivateSubnet01' | jq -r '.Subnets[].SubnetId')
export PrivateSubnet02=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=mj-test-stack-PrivateSubnet02' | jq -r '.Subnets[].SubnetId')
export PrivateSubnet03=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=mj-test-stack-PrivateSubnet03' | jq -r '.Subnets[].SubnetId')
...
# eks cluster 환경변수 생성 
export ekscluster_name="mj-test-stack"
...
export publicKeyPath="/home/ec2-user/environment/mjtest.pub"
